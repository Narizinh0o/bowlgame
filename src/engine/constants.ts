...
/** Случайные события матча (генерятся перед драфтом). Клубные — ВСЕГДА, их
 *  количество случайно по весам (1..4 клуба); прочие события — независимо. */
export const CLUB_EVENTS_WEIGHTS = [30, 35, 25, 10] // веса для 1/2/3/4 клубов
